...
module.exports = "<div class=\"main-content\">\n  <div class=\"row\">\n      <div class=\"col-md-12\">\n          <div class=\"card \">\n            <div class=\"card-header \">\n              <h4 class=\"card-title\">Stacked Form</h4>\n            </div>\n            <div class=\"card-body \">\n              <form method=\"#\" action=\"#\">\n                <label>App PID</label>\n                <div class=\"form-group\">\n                  <input type=\"text\" class=\"form-control\" placeholder=\"Enter pid\">\n                  <!--<div class=\"input-group\">\n                      <div class=\"custom-file\">\n                          <label for=\"file\">Choose File</label>\n                          <input type=\"file\"\n                                 id=\"file\"\n                                 (change)=\"handleFileInput($event.target.files)\" >\n                        <label class=\"custom-file-label\" for=\"inputGroupFile01\">{{fileData.name}}</label>\n                      </div>\n                  </div>-->\n                </div>\n              </form>\n            </div>\n            <div class=\"card-footer \">\n              <button (click)=\"runApp()\" type=\"submit\" class=\"btn btn-danger btn-round col-md-3\" style=\"float: right\">Monitor App</button>\n            </div>\n          </div>\n        </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <div class=\"card \">\n        <div class=\"card-header text-center\">\n          <h4 class=\"card-title\">SAM Apps Enviroment Monitor</h4>\n        </div>\n  <div class=\"card-body\" >\n  <div class=\"row\">\n      <div class=\"col-md-12\">\n    <div class=\"table-wrapper-scroll-y my-custom-scrollbar\" style=\"height: 1000\">\n      <div class=\"table-responsive\">\n        <table class=\"table table-bordered table-striped mb-0\">\n            <thead class=\"text-center\">\n              <th>\n                PID\n              </th>\n              <th>\n                USER\n              </th>\n              <th>\n                PR\n              </th>\n              <th>\n                NI\n              </th>\n              <th>\n                VIRT\n              </th>\n              <th>\n                RES\n              </th>\n              <th>\n                SHR\n              </th>\n              <th>\n                S\n              </th>\n              <th>\n                %CPU\n              </th>\n              <th>\n                %MEM\n              </th>\n              <th>\n                TIME+\n              </th>\n              <th>\n                COMMAND\n              </th>\n            </thead>\n            <tbody *ngFor=\"let data of topData\">\n            <!--<tbody>-->\n              <tr>\n                <td data-target=\"#myModal\" (click)=\"test(data.pid)\">{{data.pid}}</td>\n                <td>{{data.user}}</td>\n                <td>{{data.pr}}</td>\n                <td>{{data.ni}}</td>\n                <td>{{data.virt}}</td>\n                <td>{{data.res}}</td>\n                <td>{{data.shr}}</td>\n                <td>{{data.s}}</td>\n                <td>{{data.cpu}}</td>\n                <td>{{data.mem}}</td>\n                <td>{{data.time}}</td>\n                <td>{{data.command}}</td>\n              </tr>\n              \n            </tbody>\n          </table>\n          \n    </div>\n    </div>\n    <div class=\"card-footer \">\n        <button (click)=\"getTop()\"  class=\"btn btn-success btn-round col-md-3\" style=\"float: right\">Refresh</button>\n      </div>\n    </div> \n    </div>\n  </div>\n      </div>\n  </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col\">\n      <div class=\"card card-stats\">\n        <div class=\"card-body \">\n          <div class=\"row\">\n            <div class=\"col-5 col-md-4\">\n              <div class=\"icon-big text-center icon-warning\">\n                <i class=\"nc-icon nc-settings-gear-64 text-warning\"></i>\n              </div>\n            </div>\n            <div class=\"col-7 col-md-8\">\n              <div class=\"numbers\">\n                <p class=\"card-category\">Memory</p>\n                <p class=\"card-title\">150GB\n                </p>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"card-footer \">\n          <hr>\n          <div class=\"stats\">\n            <i class=\"fa fa-refresh\"></i> Get Stats\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"col\">\n      <div class=\"card card-stats\">\n        <div class=\"card-body \">\n          <div class=\"row\">\n            <div class=\"col-5 col-md-4\">\n              <div class=\"icon-big text-center icon-warning\">\n                <i class=\"nc-icon nc-button-power text-warning\"></i>\n              </div>\n            </div>\n            <div class=\"col-7 col-md-8\">\n              <div class=\"numbers\">\n                <p class=\"card-category\">CPU</p>\n                <p class=\"card-title\">150GB\n                </p>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"card-footer \">\n          <hr>\n          <div class=\"stats\">\n            <i class=\"fa fa-refresh\"></i> Get Stats\n          </div>\n        </div>\n      </div>\n    </div>\n    <div class=\"col\">\n      <div class=\"card card-stats\">\n        <div class=\"card-body \">\n          <div class=\"row\">\n            <div class=\"col-5 col-md-4\">\n              <div class=\"icon-big text-center icon-warning\">\n                <i class=\"nc-icon nc-settings-gear-64 text-warning\"></i>\n              </div>\n            </div>\n            <div class=\"col-7 col-md-8\">\n              <div class=\"numbers\">\n                <p class=\"card-category\">Power Consumption</p>\n                <p class=\"card-title\">150GB\n                </p>\n              </div>\n            </div>\n          </div>\n        </div>\n        <div class=\"card-footer \">\n          <hr>\n          <div class=\"stats\">\n            <i class=\"fa fa-refresh\"></i> Get Stats\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-md-12\">\n      <div class=\"card \">\n        <div class=\"card-header text-center\">\n          <h4 class=\"card-title\">SAM Variables Monitor</h4>\n          <p class=\"card-category\">All products that were shipped</p>\n        </div>\n        <div class=\"card-body\" >\n          <div class=\"row\">\n            <div class=\"col\">\n              <div class=\"table-wrapper-scroll-y my-custom-scrollbar\">\n                <div class=\"table-responsive\">\n                  <table class=\"table table-bordered table-striped mb-0\">\n                      <thead class=\"text-center\">\n                        <th>\n                          Name\n                        </th>\n                        <th>\n                          Date\n                        </th>\n                        <th>\n                          Memory(kb)\n                        </th>\n                      </thead>\n                      <tbody *ngFor=\"let data of memoryData\">\n                        <tr>\n                          <td>{{data.name}}</td>\n                          <td>{{data.date | date:\"yyyy-MM-dd\"}}</td>\n                          <td>{{data.memoryValue}}</td>\n                        </tr>\n                        \n                      </tbody>\n                    </table>\n              </div>\n              </div> \n            </div>\n            <div class=\"col\">\n              <div class=\"table-wrapper-scroll-y my-custom-scrollbar\">\n                <div class=\"table-responsive\">\n                  <table class=\"table table-bordered table-striped mb-0\">\n                      <thead class=\"text-center\">\n                        <th>\n                          Name\n                        </th>\n                        <th>\n                          Date\n                        </th>\n                        <th>\n                          Memory(kb)\n                        </th>\n                      </thead>\n                      <tbody *ngFor=\"let data of memoryData\">\n                        <tr>\n                          <td>{{data.name}}</td>\n                          <td>{{data.date | date:\"yyyy-MM-dd\"}}</td>\n                          <td>{{data.memoryValue}}</td>\n                        </tr>\n                        \n                      </tbody>\n                    </table>\n              </div>\n              </div> \n            </div>\n            <div class=\"col\">\n              <div class=\"table-wrapper-scroll-y my-custom-scrollbar\">\n                <div class=\"table-responsive\">\n                  <table class=\"table table-bordered table-striped mb-0\">\n                      <thead class=\"text-center\">\n                        <th>\n                          Name\n                        </th>\n                        <th>\n                          Date\n                        </th>\n                        <th>\n                          Memory(kb)\n                        </th>\n                      </thead>\n                      <tbody *ngFor=\"let data of memoryData\">\n                        <tr>\n                          <td>{{data.name}}</td>\n                          <td>{{data.date | date:\"yyyy-MM-dd\"}}</td>\n                          <td>{{data.memoryValue}}</td>\n                        </tr>\n                        \n                      </tbody>\n                    </table>\n              </div>\n              </div> \n            </div>\n          </div>\n        </div>\n      </div>\n    </div>\n  </div>\n"
...
var constants = /** @class */ (function () {
    ...
    constants.apiURL = 'http://192.168.0.26:8080';
    constants.uploadFileURL = '/app/';
    constants.runAppURL = '/runapp/';
    return constants;
}());
...
module.exports = ".my-custom-scrollbar {\n  position: relative;\n  height: 200px;\n  overflow: auto;\n}\n\n.table-wrapper-scroll-y {\n  display: block;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_datasets__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/datasets */ "./src/app/models/datasets.ts");
/* harmony import */ var rxjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/_esm5/index.js");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(fileService, http) {
    ...
    DashboardComponent.prototype.subscribe = function () {
        ...
        this.subscription = source.subscribe(function (val) { return _this.addData(); });
    ...
    DashboardComponent.prototype.runApp = function () {
        //this.fileService.runApp(this.fileData.name,()=>{})
    };
    DashboardComponent.prototype.addData = function () {
        var mem = new _models_datasets__WEBPACK_IMPORTED_MODULE_1__["memory"]();
        mem.date = new Date();
        mem.name = "AppTest";
        mem.memoryValue = 5.1;
    ...
    DashboardComponent.prototype.getTop = function () {
        ...
        var url = _config_constants__WEBPACK_IMPORTED_MODULE_6__["constants"].apiURL + "/top";
        this.http
            .get(url)
            .subscribe(function (data) {
            _this.topData = data['result'];
        });
    };
    DashboardComponent.prototype.run = function () {
    };
    DashboardComponent.prototype.test = function (text) {
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire({
            title: 'Are you sure?',
            text: 'Do you want to monitor the app ' + text + '?',
            type: 'question',
        ...
        sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Do you want to monitor the app ' + text + '?');
    };
    DashboardComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_file_service__WEBPACK_IMPORTED_MODULE_5__["FileService"], _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpClient"]])
    ], DashboardComponent);
...
var DashboardModule = /** @class */ (function () {
    ...
    DashboardModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_services_file_service__WEBPACK_IMPORTED_MODULE_4__["FileService"]]
        })
    ], DashboardModule);
...
/***/ "./src/app/models/datasets.ts":
/*!************************************!*\
  !*** ./src/app/models/datasets.ts ***!
  \************************************/
/*! exports provided: memory, cpu, power, top */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var apiUrl = _config_constants__WEBPACK_IMPORTED_MODULE_2__["constants"].apiURL;
var FileService = /** @class */ (function () {
    function FileService(http) {
        this.http = http;
    }
    FileService.prototype.uploadDoc = function (app, cb) {
        var appFormData = new FormData();
        appFormData.append('fileUploaded', app, app.name);
        console.log("Uploading file " + appFormData);
        return this.http.post(_config_constants__WEBPACK_IMPORTED_MODULE_2__["constants"].apiURL + _config_constants__WEBPACK_IMPORTED_MODULE_2__["constants"].uploadFileURL + app.name, app, {
            ...
            sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire('Error', 'Error de comunicación con el servidor', 'error');
        });
    };
    FileService.prototype.runApp = function (app, cb) {
        return this.http.post(_config_constants__WEBPACK_IMPORTED_MODULE_2__["constants"].apiURL + _config_constants__WEBPACK_IMPORTED_MODULE_2__["constants"].runAppURL + app, null, {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"](
            // {
            // 'Content-Type' : 'application/json'
            // }
